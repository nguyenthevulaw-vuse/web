...
insert into public.practice_areas (slug, title, summary, content, icon, "order") values
  ...
  ('tranh-tung-giai-quyet-tranh-chap', 'Tranh tụng & Giải quyết tranh chấp', 'Đại diện tham gia tố tụng tại Tòa án, Trọng tài thương mại.', 'Luật sư giàu kinh nghiệm tranh tụng, trực tiếp đại diện và bảo vệ quyền, lợi ích hợp pháp của khách hàng tại Tòa án các cấp và các Trung tâm Trọng tài thương mại.', 'Scale', 7),
...
-- Dọn các hồ sơ luật sư mẫu (hư cấu) từ bản seed cũ, nếu trước đó đã chạy —
-- NTVLaw hiện là công ty luật TNHH một thành viên, chỉ có một luật sư.
delete from public.team_members
where slug in ('nguyen-van-an', 'tran-thi-bich', 'le-minh-cuong', 'pham-thu-ha');

insert into public.team_members (slug, name, title, summary, bio, initials, "order") values
  ('nguyen-the-vu', 'LS. Nguyễn Thế Vũ', 'Giám đốc', 'Thẻ luật sư số 6396 — Thành viên Đoàn Luật sư TP. Hồ Chí Minh.', 'Luật sư Nguyễn Thế Vũ là người sáng lập và Giám đốc NTVLaw, được cấp Thẻ luật sư số 6396 ngày 25/7/2011, thành viên Đoàn Luật sư Thành phố Hồ Chí Minh. Luật sư trực tiếp phụ trách tư vấn pháp luật, tham gia tố tụng và đại diện ngoài tố tụng cho khách hàng là doanh nghiệp và cá nhân.', 'NTV', 1)
on conflict (slug) do update set
  name = excluded.name,
  title = excluded.title,
  summary = excluded.summary,
...
insert into public.faqs (question, answer, category) values
  ('Chi phí tư vấn pháp lý ban đầu có mất phí không?', 'NTVLaw cung cấp buổi tư vấn sơ bộ ban đầu miễn phí để đánh giá tổng quan vụ việc. Chi phí dịch vụ cụ thể sẽ được báo giá minh bạch sau khi luật sư nắm rõ yêu cầu và phạm vi công việc của khách hàng.', 'chung'),
